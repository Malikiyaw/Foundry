      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/setup" className="btn-ghost !py-2 !px-4 !text-sm">
              Get Started
            </Link>
            <Link to="/setup" className="btn-primary !py-2 !px-4 !text-sm">
              Launch Foundry
            </Link>
          </div>
        </div>
      ...
      <section className="relative flex min-h-screen items-center justify-center pt-20">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/setup" className="btn-primary !py-3 !px-8 !text-base !rounded-xl flex items-center gap-2">
              Start Building Free
      ...
      <section className="py-24 relative">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <div className="gradient-border p-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/setup" className="btn-primary !py-3 !px-8 !text-base !rounded-xl">
                Get Started Free
              </Link>
